module ApikeyDashboard
  class User < ActiveRecord::Base
    ...
    validates :email,
              presence: {
                message: 'Du måste ange en e-post!'
              },
              length: {
                maximum: 255,
    ...
    validates :first_name,
              length: {
                minimum: 2,
                maximum: 20,
                message: 'Förnamnet måste vara minst 2 tecken och max 20 tecken.'
              }
    validates :last_name,
              length: {
                minimum: 2,
                maximum: 30,
                message: 'Efternamnet måste vara minst 2 tecken och max 20 tecken.'
              }
  end
end
