...
u = User.create(username: 'Oskar', password: '123456', password_confirmation: '123456', first_name: 'Oskar', last_name: 'Klintrot')
...
u = User.create(username: 'Erik', password: '345678', password_confirmation: '345678', first_name: 'Erik', last_name: 'Svensson')
